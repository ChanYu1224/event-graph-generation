"""Resize videos for downstream processing (long side → max_side px).

Reads videos from input directory, resizes so the long side equals
max_side (default 384), and writes to output directory preserving
...
Usage:
    uv run python scripts/0_resize_videos.py --input-dir data/raw --output-dir data/resized --max-side 384
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Resize videos for downstream processing.")
    parser.add_argument(
        "--input-dir",
        type=str,
        default="data/mp4",
